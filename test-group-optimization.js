...
/**
 * Test script to verify Group website image optimization is working correctly
 */

function testImageOptimization() {
    console.log('🧪 Testing Group Website Image Optimization');
    console.log('==========================================');
    ...
    const testFiles = [
        'road_safety.avif',
        'road_safety.webp',
        'rail_infrastructure.avif',
        'rail_infrastructure.webp',
        'security.avif',
        'security.webp',
        'energy.avif',
        'energy.webp'
