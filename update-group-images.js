...
/**
 * Update Group website HTML files to use AVIF → WebP → JPEG fallback strategy
 * 
 * This script processes all HTML files in the Group website and converts
...
function processHtmlContent(htmlContent) {
    ...
    // Pattern to match img tags (excluding those already in picture elements)
    ...
    updatedContent = updatedContent.replace(imgPattern, (match, beforeSrc, imagePath, extension, afterSrc) => {
        ...
        // Check if we're inside a picture element
...
function processCssBackgrounds(cssContent) {
    ...
    updatedContent = updatedContent.replace(bgPattern, (match, imagePath, extension) => {
        ...
        if (webp) {
            ...
            return `url('${nameWithoutExt}.webp')`;
        }
 ...
 */
function main() {
    console.log('🚀 Group Website Image Optimization');
    console.log('====================================');
